...
require_once PLUGINS_PATH . '/payments/unionpay/sdk/acp_service.php';
...
class unionpay {
    ...
    public function __construct($payment_info = array(), $order_info = array()) {
        if (!empty($payment_info)) {
            ...
            com\unionpay\acp\sdk\SDKConfig::setSDKConfig('encryptCertPath',PLUGINS_PATH . '/payments/unionpay/asserts/acp_prod_enc.cer');
            com\unionpay\acp\sdk\SDKConfig::setSDKConfig('middleCertPath',PLUGINS_PATH . '/payments/unionpay/asserts/acp_prod_middle.cer');
            com\unionpay\acp\sdk\SDKConfig::setSDKConfig('rootCertPath',PLUGINS_PATH . '/payments/unionpay/acp_prod_root.cer');
            com\unionpay\acp\sdk\SDKConfig::setSDKConfig('logFilePath',PLUGINS_PATH . '/payments/unionpay/logs');
        }
    }
