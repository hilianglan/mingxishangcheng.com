...
class Index extends MobileMall {
     ...
     * @apiSuccess {String} result.editable_page.editable_page_path  index/index商场首页store/index店铺首页special/index专题活动页
     * @apiSuccess {Int} result.editable_page.editable_page_item_id  页面项目id
     * @apiSuccess {Int} result.editable_page.store_id  店铺id
     ...
     * @apiSuccess {String} result.config_list.instant_message_gateway_url  聊天接口地址
     * @apiSuccess {String} result.config_list.instant_message_open  是否开启聊天 1是0否
