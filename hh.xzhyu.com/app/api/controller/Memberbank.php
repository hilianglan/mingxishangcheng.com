...
class Memberbank extends MobileMember {
    ...
    public function bank_list() {
        ...
        if (!empty($member_wxinfo) && is_array($member_wxinfo) && isset($member_wxinfo['member_wxopenid']) && $member_wxinfo['member_wxopenid']) {
            ...
            $bank_list[] = array('memberbank_id' => -1, 'memberbank_type' => 'weixin', 'memberbank_no' => $member_wxinfo['nickname'], 'member_wxinfo' => $member_wxinfo);
        }
    ...
    public function bank_info() {
        $memberbank_id = intval(input('post.memberbank_id'));
        ...
        if (!empty($memberbank_id) && $bank_info['member_id'] == $this->member_info['member_id']) {
    ...
    public function bank_del() {
        ...
        $memberbank_model->delMemberbank($condition);
