...
class Pointcart extends MobileMember {
    ...
    public function initialize() {
        ...
        if (config('ds_config.pointprod_isuse') != 1) {
            ds_json_encode(10001,lang('pointcart_unavailable'));
        }
    }
    ...
    public function step1() {
        ...
        //实例化收货地址模型（不显示门店地址）
        $address_list = model('address')->getAddressList(array('member_id' => $this->member_info['member_id'], 'chain_id' => 0), 'address_is_default desc,address_id desc');
