...
class Sellerrefund extends MobileSeller {
    ...
    public function refund_list() {
        ...
        $condition[] = array('refund_type', '=', $refund_type); //类型:1为退款,2为退货
        ...
        foreach ($refund_list as $k => $v) {
            ...
            $refund_list[$k]['delay_time'] = TIMESTAMP - $v['delay_time'] - 60 * 60 * 24 * $return_delay;
        }
    ...
    public function search_deliver() {
        ...
        if(isset($express[$return['express_id']])){
