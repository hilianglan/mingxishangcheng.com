...
class Sellerorder extends MobileSeller {
    ...
    public function order_list() {
        ...
        $order_list = $order_model->getOrderList($condition, (($pagesize < 1) ? 10 : $pagesize), '*', 'order_id desc', '', array('order_goods', 'order_common', 'ppintuanorder', 'member'));
    ...
    public function order_cancel() {
        ...
        try{
            Db::startTrans();
            model('order', 'logic')->changeOrderStateCancel($order_info, 'seller', $this->seller_info['seller_name'], $reason);
        } catch (\Exception $e) {
            Db::rollback();
