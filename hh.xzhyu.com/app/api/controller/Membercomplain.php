...
class Membercomplain extends MobileMember {
     ...
     * @apiSuccess {Int} result.goods_list.goods_type  商品类型 1默认2抢购商品3秒杀商品4组合套装5赠品6拼团7会员等级折扣
    ...
    public function index() {
        ...
        $condition = array();
        $condition[] = array('accuser_id', '=', $this->member_info['member_id']);
     ...
     * @apiSuccess {Int} result.return_info.goods_list.goods_type  商品类型 1默认2抢购商品3秒杀商品4组合套装5赠品6拼团7会员等级折扣
    ...
    private function check_complain_exist($goods_id) {
        ...
        $param[] = array('accuser_id', '=', $this->member_info['member_id']);
