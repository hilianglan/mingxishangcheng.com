...
class  Point extends Validate
{
    protected $rule = [
        'member_name'=>'require',
        'points_num'=>'require|number|min:1',
        'goodsname'=>'require',
        'goodsprice'=>'require',
        ...
        // 'member_id'=>'require',
        'member_friend_id'=>'require',
        
        
    ];
    protected $message = [
        'member_name.require'=>'会员信息错误，请重新填写会员名',
        'points_num.require'=>'请添加积分',
        ...
        // 'member_id.require'=>'请添加会员id',
        'member_friend_id.require'=>'请添加好友id'
    ];
    protected $scene = [
        ...
        'member_to_friend_points' => ['member_friend_id','points_num'],
