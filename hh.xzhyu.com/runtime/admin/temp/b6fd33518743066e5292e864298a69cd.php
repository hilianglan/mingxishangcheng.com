<?php /*a:3:{s:66:"/www/wwwroot/hh.xzhyu.com/app/admin/view/refund/refund_manage.html";i:1657785098;s:59:"/www/wwwroot/hh.xzhyu.com/app/admin/view/public/header.html";i:1657785098;s:64:"/www/wwwroot/hh.xzhyu.com/app/admin/view/public/admin_items.html";i:1657785098;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <div class="explanation" id="explanation">
        ...
        <ul>
            <li><?php echo htmlentities(lang('refund_manage_help1')); ?></li>
        </ul>
    </div>
    ...
    <form method="get">
        <div class="ds-search-form">
            ...
            <div class="btn_group">
                ...
                <a href="<?php echo url('Refund/refund_manage'); ?>" class="btn btn-default" title="<?php echo htmlentities(lang('ds_cancel')); ?>"><?php echo htmlentities(lang('ds_cancel')); ?></a>
            </div>
        </div>
    </form>
    ...
    <table class="ds-default-table">
        <thead>
            <tr class="thead">
                ...
                <th class="align-center"><?php echo htmlentities(lang('refund_seller_time')); ?></th>
        ...
        <tbody>
            ...
            <tr class="bd-line" >
                ...
                <td class="align-center">
                    <a href="javascript:dsLayerOpen('<?php echo url('Refund/edit',['refund_id'=>$val['refund_id']]); ?>','<?php echo htmlentities(lang('refund_order')); ?>-<?php echo htmlentities($val['order_sn']); ?>')" class="dsui-btn-add"><?php echo htmlentities(lang('ds_verify')); ?></a>
                </td>
            </tr>
           <?php endforeach; endif; else: echo "" ;endif; ?>
        </tbody>
