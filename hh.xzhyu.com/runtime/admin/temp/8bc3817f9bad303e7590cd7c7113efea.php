<?php /*a:3:{s:63:"/www/wwwroot/hh.xzhyu.com/app/admin/view/refund/refund_all.html";i:1657785098;s:59:"/www/wwwroot/hh.xzhyu.com/app/admin/view/public/header.html";i:1657785098;s:64:"/www/wwwroot/hh.xzhyu.com/app/admin/view/public/admin_items.html";i:1657785098;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<?php endif; ?>
    ...
    <form method="get">
        <div class="ds-search-form">
            ...
            <dl>
                <dt><?php echo htmlentities(lang('refund_buyer_add_time')); ?></dt>
                <dd>
            ...
            <div class="btn_group">
                ...
                <a href="<?php echo url('Refund/refund_all'); ?>" class="btn btn-default" title="<?php echo htmlentities(lang('ds_cancel')); ?>"><?php echo htmlentities(lang('ds_cancel')); ?></a>
                <a class="btn" href="javascript:export_xls('<?php echo url('Refund/export_step1'); ?>')"><span><?php echo htmlentities(lang('ds_export')); ?>Excel</span></a>
            </div>
        </div>
    </form>
    ...
    <table class="ds-default-table">
        <thead>
            <tr class="thead">
                ...
                <th class="align-center"><?php echo htmlentities(lang('refund_seller_state')); ?></th>
                <th class="align-center"><?php echo htmlentities(lang('refund_admin_state')); ?></th>
        ...
        <tbody>
            ...
            <tr class="bd-line" >
                ...
                <td class="align-center">
                    <a href="javascript:dsLayerOpen('<?php echo url('Refund/view',['refund_id'=>$val['refund_id']]); ?>','<?php echo htmlentities(lang('ds_view')); ?>-<?php echo htmlentities($val['order_sn']); ?>')" class="dsui-btn-view"><i class="iconfont"></i><?php echo htmlentities(lang('ds_view')); ?></a>
                </td>
            </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>            
        </tbody>
