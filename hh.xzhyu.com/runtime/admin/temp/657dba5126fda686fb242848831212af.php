<?php /*a:3:{s:63:"/www/wwwroot/hh.xzhyu.com/app/admin/view/dashboard/welcome.html";i:1670990108;s:59:"/www/wwwroot/hh.xzhyu.com/app/admin/view/public/header.html";i:1657785098;s:64:"/www/wwwroot/hh.xzhyu.com/app/admin/view/public/admin_items.html";i:1657785098;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info-panel">
            ...
            <div class="mc">
                <ul>
                    ...
                    <li class="none">
                        <a href="<?php echo url('MemberAuth/index'); ?>">
                            <div class="p_header bg-86CE86">
                                <i class="iconfont">&#xe6ea;</i>
                            </div>
                            <div class="p_content">
                                <div class="p_text"><?php echo htmlentities(lang('dashboard_wel_member_auth')); ?></div>
                ...
                <ul>
                    ...
                    <li class="none">
                        <a href="<?php echo url('Voucher/index'); ?>">
                            ...
                            <div class="p_content">
                                <div class="p_text"><?php echo htmlentities(lang('dashboard_wel_voucher')); ?></div>
                    ...
                    <li class="none">
                        <a href="<?php echo url('Promotionpintuan/index'); ?>">
                            ...
                            <div class="p_content">
                                <div class="p_text"><?php echo htmlentities(lang('dashboard_wel_pintuan')); ?></div>
                    ...
                    <li class="none">
                        <a href="<?php echo url('Promotionmansong/index'); ?>">
                            ...
                            <div class="p_content">
                                <div class="p_text"><?php echo htmlentities(lang('dashboard_wel_mansong')); ?></div>
                    ...
                    <li class="none">
                        <a href="<?php echo url('Promotionpresell/index'); ?>">
                            ...
                            <div class="p_content">
                                <div class="p_text"><?php echo htmlentities(lang('dashboard_wel_presell')); ?></div>
