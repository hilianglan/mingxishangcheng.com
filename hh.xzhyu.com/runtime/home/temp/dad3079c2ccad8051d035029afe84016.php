<?php /*a:6:{s:78:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/seller/sellerreturn/index.html";i:1657785122;s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/base_seller.html";i:1657785114;s:68:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/seller_top.html";i:1660125338;s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/seller_left.html";i:1657785114;s:70:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/seller_items.html";i:1657785114;s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/mall_footer.html";i:1657785114;}*/ ?>
<!doctype html>
<html>
    <head>
...
<form method="get" action="">
    ...
    <table class="search-form">
        <tr>
            <td>&nbsp;</td><th><?php echo htmlentities(lang('return_order_add_time')); ?></th>
            <td class="w240">
                <input type="text" class="text w70" name="add_time_from" id="add_time_from" value="<?php echo htmlentities(app('request')->param('add_time_from')); ?>" />
                <label class="add-on"><i class="iconfont">&#xe8d6;</i></label>&nbsp;&#8211;&nbsp;
                <input id="add_time_to" type="text" class="text w70"  name="add_time_to" value="<?php echo htmlentities(app('request')->param('add_time_to')); ?>" />
                <label class="add-on"><i class="iconfont">&#xe8d6;</i></label>
            </td>
            ...
            <th class="w120">
                <select name="type">
                    <option value="order_sn" <?php if(app('request')->param('type') == 'order_sn'): ?>selected<?php endif; ?>><?php echo htmlentities(lang('return_order_ordersn')); ?></option>
                    <option value="return_sn" <?php if(app('request')->param('type') == 'return_sn'): ?>selected<?php endif; ?>><?php echo htmlentities(lang('return_order_returnsn')); ?></option>
                    <option value="buyer_name"<?php if(app('request')->param('type') == 'buyer_name'): ?>selected<?php endif; ?>><?php echo htmlentities(lang('return_order_buyer')); ?></option>
                </select>
            </th>
            <td class="w160"><input type="text" class="text" name="keyword" value="<?php echo htmlentities(app('request')->get('keyword')); ?>" /></td>
            <td class="w70 tc"><input type="submit" class="submit" value="<?php echo htmlentities(lang('ds_search')); ?>" /></td>
        </tr>
    </table>
</form>
<table class="dssc-default-table">
    <thead>
        <tr>
            ...
            <th class="w150"><?php echo htmlentities(lang('return_order_return')); ?></th>
    ...
    <tbody>
        <?php if(!(empty($return_list) || (($return_list instanceof \think\Collection || $return_list instanceof \think\Paginator ) && $return_list->isEmpty()))): if(is_array($return_list) || $return_list instanceof \think\Collection || $return_list instanceof \think\Paginator): if( count($return_list)==0 ) : echo "" ;else: foreach($return_list as $key=>$val): ?>
        <tr class="bd-line" >
            <td></td>
            <td class="w50">
                <div class="pic-thumb"><a href="<?php echo url('Goods/index',['goods_id'=>$val['goods_id']]); ?>" target="_blank">
                        <img src="<?php echo goods_thumb($val, 240); ?>" /></a>
                </div>
            </td>
            <td title="<?php echo htmlentities($val['store_name']); ?>">
                <dl>
                    ...
                    <dd><?php echo htmlentities(lang('return_order_returnsn')); ?><?php echo htmlentities(lang('ds_colon')); ?><?php echo htmlentities($val['refund_sn']); ?></dd>
                </dl>
            </td>
            <td><?php echo htmlentities(lang('currency')); ?><?php echo htmlentities($val['refund_amount']); ?></td>
            <td><?php if($val['return_type'] == 2): ?><?php echo htmlentities($val['goods_num']); else: ?><?php echo htmlentities(lang('there_no')); ?><?php endif; ?></td>
            ...
            <td><?php if($val['seller_state'] == 2 && $val['refund_state'] >= 2): ?><?php echo htmlentities($admin_array[$val['refund_state']]); else: ?><?php echo htmlentities(lang('there_no')); ?><?php endif; ?></td>
            <td class="dscs-table-handle">
                <?php if($val['seller_state'] == 1): ?>
                <span><a href="<?php echo url('Sellerreturn/edit',['return_id'=>$val['refund_id']]); ?>" class="btn-blue"><i class="iconfont">&#xe731;</i><p><?php echo htmlentities(lang('deal_with')); ?></p></a></span>
                <?php else: ?>
                <span> <a href="<?php echo url('Sellerreturn/view',['return_id'=>$val['refund_id']]); ?>" class="btn-orange"><i class="iconfont">&#xe70b;</i><p><?php echo htmlentities(lang('ds_view')); ?></p></a></span>
                <?php endif; if($val['seller_state'] == 2 && $val['return_type'] == 2 && $val['goods_state'] == 2): ?>
                <span><a href="javascript:void(0)" class="btn-green" ds_type="dialog" dialog_title="<?php echo htmlentities(lang('ds_edit')); ?>" dialog_id="return_order" dialog_width="480" uri="<?php echo url('Sellerreturn/receive',['return_id'=>$val['refund_id']]); ?>"><i class="iconfont">&#xe6e9;</i><p><?php echo htmlentities(lang('goods_receipt')); ?></p></a></span>
                <?php endif; ?>
            </td>
        </tr>
