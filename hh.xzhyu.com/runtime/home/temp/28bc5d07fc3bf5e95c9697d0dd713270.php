<?php /*a:3:{s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/mall/login/login.html";i:1670990110;s:66:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/mall_top.html";i:1660791884;s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/mall_footer.html";i:1657785114;}*/ ?>
<!doctype html>
<html>
    <head>
            ...
            <div class="mc">
                <form id="login_normal_form" method="post" action="<?php echo url('Login/login'); ?>">
                    ...
                    <div class="item">
                        <div class="text-area">
                            <div class="iconfont ico">&#xe67b;</div>
                            <input type="password" id="member_password" name="member_password" autocomplete="new-password" class="text" placeholder="<?php echo htmlentities(lang('login_password')); ?>" tabindex="2"/>
                        </div>
                    </div>
                ...
                <form id="login_mobile_form" method="post" action="<?php echo url('Connectsms/login'); ?>" style="display:none">
                    ...
                    <div class="item">
                        <input type="hidden" value="<?php echo htmlentities($ref_url); ?>" name="ref_url">
                        <input type="submit" class="btn login-btn" value="<?php echo htmlentities(lang('login_register_login_now_2')); ?>"/>
                    </div>    
                </form>
                <?php endif; ?>
...
$(function () {
    ...
    $("#login_normal_form").validate({
        ...
        submitHandler:function(form){
            ds_ajaxpost('login_normal_form','url','<?php if($ref_url): ?><?php echo htmlentities($ref_url); else: ?><?php echo url("Member/index"); ?><?php endif; ?>');
        },
        onkeyup: false,
        rules: {
...
<script>
            $(function () {
                $("#login_mobile_form").validate({
                    ...
                    submitHandler:function(form){
                        ds_ajaxpost('login_mobile_form','url','<?php if($ref_url): ?><?php echo htmlentities($ref_url); else: ?><?php echo url("Member/index"); ?><?php endif; ?>');
                    },
                    onkeyup: false,
                    rules: {
                        sms_mobile: {
...
<?php endif; if(config('ds_config.instant_message_open') == '1' && !isset($wait) && request()->controller() != 'Payment' && request()->controller() != 'Showgroupbuy'): ?>
<?php echo get_chat(); ?>
<?php endif; ?>
