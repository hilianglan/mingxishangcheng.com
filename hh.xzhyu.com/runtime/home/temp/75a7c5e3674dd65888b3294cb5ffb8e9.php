<?php /*a:7:{s:77:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/seller/sellerrefund/view.html";i:1657785122;s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/base_seller.html";i:1657785114;s:68:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/seller_top.html";i:1660125338;s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/seller_left.html";i:1657785114;s:70:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/seller_items.html";i:1657785114;s:92:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/seller/sellerrefund/seller_refund_right.html";i:1657785122;s:69:"/www/wwwroot/hh.xzhyu.com/app/home/view/default/base/mall_footer.html";i:1657785114;}*/ ?>
<!doctype html>
<html>
    <head>
    ...
    <div class="dssc-flow-container">
        ...
        <div id="saleRefund">
            <div class="dssc-flow-step">
                ...
                <dl class="<?php if($refund['admin_time']): ?>current<?php endif; ?>">
        ...
        <div class="dssc-form-default">
            ...
            <dl>
                <dt><?php echo htmlentities(lang('processing_state')); ?><?php echo htmlentities(lang('ds_colon')); ?></dt>
                <dd><?php echo htmlentities($state_array[$refund['seller_state']]); ?></dd>
            </dl>
            <?php if($refund['seller_time'] > 0): ?>
            <dl>
                <dt><?php echo htmlentities(lang('refund_seller_message')); ?><?php echo htmlentities(lang('ds_colon')); ?></dt>
                <dd> <?php echo htmlentities($refund['seller_message']); ?> </dd>
            </dl>
            <?php endif; if($refund['seller_state'] == 2): ?>
            <h3><?php echo htmlentities(lang('refund_check_mall_platform')); ?></h3>
            <dl>
                <dt><?php echo htmlentities(lang('platform_confirm')); ?><?php echo htmlentities(lang('ds_colon')); ?></dt>
                <dd><?php echo htmlentities($admin_array[$refund['refund_state']]); ?></dd>
            </dl>
            <?php endif; if($refund['admin_time'] > 0): ?>
            <dl>
                <dt><?php echo htmlentities(lang('platform_note')); ?><?php echo htmlentities(lang('ds_colon')); ?></dt>
                <dd> <?php echo htmlentities($refund['admin_message']); ?> </dd>
            </dl>
            <?php endif; ?>
            <div class="bottom">
                <label class=""><a href="javascript:history.go(-1);" class="dssc-btn"><i class="iconfont">&#xe74e;</i><?php echo htmlentities(lang('returns_list')); ?></a></label>
            </div>
        </div>
    </div>
