...
class Memberfavorites extends MobileMember {
    ...
    public function favorites_list() {
        ...
        $favorites_list = $favorites_model->getGoodsFavoritesList(array(array('member_id' ,'=', $this->member_info['member_id'])), '*', $this->pagesize);
        $favorites_id = '';
    ...
    public function favorites_add() {
        ...
        if (!empty($favorites_info)) {
            ds_json_encode(10001, lang('favorite_already_favorite_goods'));
        }
        ...
        if ($goods_info['store_id'] == $seller_info['store_id']) {
            ds_json_encode(10001, lang('favorite_no_my_product'));
        }
    ...
    public function favorites_del() {
        ...
        if (empty($favorites_info)) {
            ds_json_encode(10001, lang('favorite_goods_not_exist'));
        }
