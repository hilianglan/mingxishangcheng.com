...
class Goodsclass extends MobileMall {
     ...
     *
     * @apiSuccess {String} code 返回码10000为成功
    ...
    public function index()
    {
        ...
        $update_all = 0; //hehao新增
        $goods_class = $goodsclass_model->get_all_category($update_all);//hehao新增
        // $goods_class = $goodsclass_model->get_all_category();//hehao注释
        ...
        // var_dump($result);
        // $result = array();
        // $result = array(0 =>array('gc_id' => 1,'gc_name' => ' 手机/ 运营商/ 智能数码','gc_image' =>''  ,'type_id' => 1,'type_name' => '联动','gc_parent_id' => 0,'commis_rate' => 1,'gc_sort' => 0,'gc_virtual' => 1,'gc_title' => NULL,'gc_keywords' => '','gc_description' => '','gc_show' => 0,'deep' => 1,'class2' => array(2 =>  array('gc_id' => 2,'gc_name' => '手机通讯','gc_image' => '','type_id' => 1,'type_name' => '联动','gc_parent_id' => 1,'commis_rate' => 1,'gc_sort' => 0,'gc_virtual' => 1,'gc_title' => NULL,'gc_keywords' => '', 'gc_description' => '','gc_show' => 0,'deep' => 2,'class3' =>array(0 =>array('gc_id' => 75,'gc_name' =>'小米' ,'gc_image' => '606fd28418a92.png','type_id' => 1,'type_name' => '联动', 'gc_parent_id' => 2 ,'commis_rate' => 1,'gc_sort' => 255,'gc_virtual' => 1,'gc_title' => NULL, 'gc_keywords' => '','gc_description' => '','gc_show' => 1,'deep' => 3))))));//hehao新增；
        // var_dump($result);
