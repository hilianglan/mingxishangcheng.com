...
class Mallvouchertemplate extends BaseModel
{
     ...
     * @return type
     */
    public function getMallvoucheruserList($where, $field = '*')
    {
        $mallvoucheruser_list = array();
        $mallvoucheruser_list = Db::name('mallvoucheruser')->field($field)->where($where)->select()->toArray();
        return $mallvoucheruser_list;
    }
